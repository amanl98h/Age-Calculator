...
function calculateDifference(e) {
    ...
    if (resultDay === 0 && resultMonth === 0)
        return (result.textContent = `Happy Birthdayy, Today is your ${resultYear}${resultYear === 1 ? "st" : resultYear === 2 ? "nd" : "th"
            } birthday !`);

    result.textContent = `Passed ${resultYear !== 0 && resultYear > 1
            ? resultYear + " years "
            : resultYear === 1
                ? resultYear + " year "
                : ""
